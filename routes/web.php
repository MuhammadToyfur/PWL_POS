...
Route::group(['prefix' =>'kategoriController'],function(){
Route::get('/', [kategoriController::class, 'index']);          // menampilkan halaman awal kategoriController
Route::post('/list', [kategoriController::class, 'list']);      // menampilkan data kategoriController dalam json untuk datables
...
Route::get('/create_ajax', [kategoriController::class, 'create_ajax']); // Menampilkan halaman form tambah kategoriController Ajax
Route::post('/ajax', [kategoriController::class, 'store_ajax']); // Menampilkan data kategoriController baru Ajax
...
Route::get('/{id}/edit_ajax', [kategoriController::class, 'edit_ajax']); // Menampilkan halaman form edit kategoriController Ajax
Route::put('/{id}/update_ajax', [kategoriController::class, 'update_ajax']); // Menyimpan perubahan data kategoriController Ajax
Route::get('/{id}/delete_ajax', [kategoriController::class, 'confirm_ajax']); // Untuk tampilkan form confirm delete kategoriController Ajax
Route::delete('/{id}/delete_ajax', [kategoriController::class, 'delete_ajax']); // Untuk hapus data kategoriController Ajax
